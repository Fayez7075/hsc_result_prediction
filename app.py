import gradio as gr
import pandas as pd
#Gradio = Python code → creting  Web app  tool
import pickle
import numpy as np
...
# The column names must match your CSV file exactly
    ...
    columns=['gender', 'age', 'address', 'famsize', 'Pstatus', 'M_Edu', 'F_Edu', 'M_Job', 'F_Job', 'relationship', 'smoker', 'tuition_fee', 'time_friends', 'ssc_result'])
...
# launch
app.launch(share= True) # it gives a link --> http://127.0.0.1:7860
